        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <h2 class="page-title d-flex justify-content-between">
                    ...
                    <?php endif; ?>
                    <a href="<?= base_url().'supplier/addsupplier'; ?>" class="btn btn-blue btn-square font-kecil btn-ku" data-bs-toggle="modal" data-bs-target="#modal-scrollable" data-title="Add Supplier"><i class="fa fa-plus mr-1"></i> Tambah data</a>
                </h2>
                </div>
            </div>
        </div>
                                ...
                                <table class="table fixcolumn nowrap table-hover mt-1" style="width: 100% !important">
                                    ...
                                    <tbody class="table-tbody font-kecil">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle"><?= $dat['kontak']; ?></td>
                                            <td class="align-middle"><?= $dat['telp']; ?></td>
                                            <td class="align-middle"><?= $dat['email']; ?></td>
                                            <td class="align-middle"><?= $dat['npwp']; ?></td>
                                            <td class="align-middle">
                                                <a href="<?= base_url().'supplier/editsupplier/'.$dat['id']; ?>" class="btn btn-sm btn-blue" data-bs-toggle="modal" data-bs-target="#modal-scrollable" data-title="Edit Personil/Karyawan" title="Edit Data"><i class="fa fa-edit"></i> Edit</a>
                                                <a href="#" data-href="<?= base_url().'supplier/hapusdata/'.$dat['id']; ?>" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal-delete" data-message="Akan menghapus data ini" title="Hapus Data"><i class="fa fa-trash-o"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
