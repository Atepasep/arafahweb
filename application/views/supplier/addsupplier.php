            ...
            <div class="col-6"> -->
                ...
                <div class="row mb-1 align-items-end">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil" id="nama" name="nama" placeholder="Nama Supplier" />
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    <div class="col-auto">
                ...
                <div class="row mb-1 align-items-end">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil" id="kontak" name="kontak" placeholder="Kontak Supplier" />
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    <div class="col-auto">
