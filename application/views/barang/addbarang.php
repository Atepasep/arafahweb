            ...
            <div class="col-6"> -->
                ...
                <div class="row mb-1 align-items-end">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil" id="nama" name="nama" placeholder="Nama Barang" />
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    <div class="col-auto">
                ...
                <div class="row mb-1 align-items-end">
                    ...
                    <div class="col">
                        ...
                        <select class="form-control form-select font-kecil" id="satuan_id" name="satuan_id">
                            ...
                            <?php foreach($satuan->result_array() as $satu): ?>
                    ...
                    <div class="row">
                        <div class="col-6 px-0">
                            <div class="col px-2">
                                ...
                                <input type="text" class="form-control font-kecil inputangka text-right" id="stok" name="stok" placeholder="Stok" />
                            </div>
                        </div>
                        <div class="col-6 px-0">
                            <div class="col px-2">
                                <label class="form-label mb-0 font-kecil">Buffer Stok</label>
                                <input type="text" class="form-control font-kecil inputangka text-right" id="stokaman" name="stokaman" placeholder="Buffer Stok" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil inputangka text-right" id="hgbeli" name="hgbeli" placeholder="Harga Beli" />
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    <div class="col-auto">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil inputangka text-right" id="hgjual" name="hgjual" placeholder="Harga Jual" />
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    <div class="col-auto">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil inputangka text-right" id="hgretail" name="hgretail" placeholder="Harga Retail" />
                    </div>
                </div>
                <hr class="m-0">
