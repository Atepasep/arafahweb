            ...
            <div class="col-6"> -->
                <div class="row mb-1 align-items-end">
                        ...
                        <a href="#" class="avatar avatar-upload rounded" id="file_browser">
                            ...
                            <?php 
                                if($data['filefoto']==''){
                                    ...
                                    $foto = base_url().'assets/images/personil/'.$data['filefoto'];
                                }
                             ?>
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil" placeholder="Kode" name="nik" id="nik" value="<?= $data['nik']; ?>" disabled />
                    ...
                    <div class="row">
                        <div class="col-8 px-0">
                            <div class="col px-2">
                                ...
                                <input type="text" class="form-control font-kecil" id="tempat" name="tempat" placeholder="Tempat Lahir" value="<?= $data['tempat']; ?>" />
                            </div>
                        </div>
                        <div class="col-4 px-0">
                            <div class="col px-2">
                                <label class="form-label mb-0 font-kecil required">Tgl Lahir</label>
                                <input type="text" class="form-control font-kecil tglpilih" id="tgl_lahir" name="tgl_lahir" placeholder="Tgl Lahir" value="<?= tglmysql($data['tgl_lahir']); ?>" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="form-selectgroup">
                              <label class="form-selectgroup-item">
                                <input type="radio" name="jenkel" id="jenkel" value="L" class="form-selectgroup-input" <?php if($data['jenkel']=='L'){ echo "checked"; }; ?>>
                              ...
                              <label class="form-selectgroup-item">
                                <input type="radio" name="jenkel" id="jenkel" value="P" class="form-selectgroup-input" <?php if($data['jenkel']=='P'){ echo "checked"; }; ?>>
                                <span class="form-selectgroup-label">
                ...
                <div class="row mb-1 align-items-end">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil" id="telp" name="telp" placeholder="Nomor Telp" value="<?= $data['telp']; ?>" />
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    <div class="col-auto">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil" id="email" name="email" placeholder="E-mail" value="<?= $data['email']; ?>" />
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    <div class="col-auto">
                    ...
                    <div class="col">
                        ...
                        <select class="form-control font-kecil form-select" id="pendidikan_id" name="pendidikan_id" placeholder="Pendidikan">
                            ...
                            <?php foreach($pendidikan->result_array() as $didik): ?>
                                <option value="<?= $didik['id'] ?>" <?php if($data['pendidikan_id']==$didik['id']){ echo "selected"; } ?>><?= $didik['pendidikan'].' # '.$didik['nama_pendidikan']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                <div class="row mb-1 align-items-end">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control font-kecil" id="jabatan" name="jabatan" placeholder="Jabatan"  value="<?= $data['jabatan']; ?>"/>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-6 px-0">
                            <div class="col px-2">
                                ...
                                <input type="text" class="form-control font-kecil tglpilih" id="tgl_kerja" name="tgl_kerja" placeholder="Tgl Masuk" value="<?= tglmysql($data['tgl_kerja']); ?>" />
                            </div>
                        </div>
                        <div class="col-6 px-0">
                            <div class="col px-2">
                                ...
                                <div>
                                <input type="text" class="form-control font-kecil tglpilih" id="tgl_keluar" name="tgl_keluar" placeholder="Tgl Keluar" value="<?= tglmysql($data['tgl_keluar']); ?>" />
                ...
                <div class="row mb-1 align-items-end">
                    ...
                    <div class="col">
                        ...
                        <textarea class="form-control font-kecil" id="ket" name="ket"><?= $data['ket']; ?></textarea>
                    </div>
                </div>
            <!-- </div>
        </div> -->
